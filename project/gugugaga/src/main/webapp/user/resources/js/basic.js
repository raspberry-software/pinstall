...
//        newLen = newArr.length,
  ...
  $(document).on("click", ".contact", function(e) {
    ...
    $(document).off("click", closeSidebar);
    var that = this,
        commonName = $(this).find(".contact__name").attr("data-common-name"),
        targetUsername = $(this).attr("data-username"),
        online = $(this).find(".contact__status").hasClass("online");
    $(".chat__name").attr("data-common-name",commonName);
    $(".chat__online").removeClass("active");
    $("#chat-target-user").attr("data-username",targetUsername);
    // load chat just  after target is set
    if(targetUsername) GuGuGaGa.ActionEvent.loadChat();
    if (online) {
//        $(".chat__online").addClass("active");
...
//        var userCommonName = localStorage.getItem("chat-data-common-name");
//        document.getElementById("commonName").textContent=userCommonName;
//    }
